...
export function SettingsContent() {
  ...
  const Settings: Array<{
    ...
    },
    {
      ...
      content: <AccountPreferences user={user} />,
    },
    {
      id: "appearance",
      title: "Appearance",
  ...
  return (
    <div className="settings-content w-full h-full shrink relative flex items-center justify-center pb-4 gap-4 px-12">
      <AnimatePresence>
        <motion.div className="settings-content-left bg-card/50 border border-border/50 w-130 h-full flex flex-col relative rounded-2xl p-5 gap-4">
          {loading ? (
            <>
