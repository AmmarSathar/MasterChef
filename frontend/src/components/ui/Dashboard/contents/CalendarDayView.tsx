    ...
    <motion.div className="w-full h-full flex gap-6 relative">
                ...
                {EXAMPLE_MEALPLAN[slot].map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-xl overflow-hidden text-left border transition ${
                        active
                    ...
                    >
                      <div className="h-44 relative">
                        ...
                        />
                        <div className="absolute inset-0 bg-linear-to-t from-black/85 to-transparent p-3 flex flex-col justify-end">
      ...
      <aside className="w-[320px] shrink-0 space-y-4">
        <div className="bg-card border border-border rounded-2xl p-4">
          ...
          <div className="mt-4 w-44 h-44 mx-auto rounded-full border-10 border-secondary border-t-accent flex items-center justify-center">
        ...
        <div className="bg-linear-to-br from-primary to-primary/70 rounded-2xl p-4 text-primary-foreground">
