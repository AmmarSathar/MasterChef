# Contribution Log - Joey

## Sprint 1

| Date | Task | Description | Time Spent |
|------|------|-------------|------------|
| 2026-02-02 | Frontend Development | Implemented login page UI | 3h |
| 2026-02-03 | Frontend Development | Implemented login page UI | 3h |
| 2026-02-05 | Backend Development | Add dietPreferences & allergies properties to user table | 1h |
...
| Date | Task | Description | Time Spent |
|------|------|-------------|------------|
| 2026-02-16 | Frontend Development | Build 'Edit' & 'Delete' recipe UI | 4h |
...
| 2026-03-XX | Unit Tests for Edit/Remove Meal Entry | Write unit tests for successful update, successful deletion, ownership validation on both, handling non-existent entry ID. | 3h |
